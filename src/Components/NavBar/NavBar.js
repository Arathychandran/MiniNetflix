  ...
  return (
    <div className="navbar">
      ...
      <div className="language-selector">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="25" height="25" viewBox="0 -2 16 16" role="img" data-icon="LanguagesSmall" aria-hidden="true">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="20" height="20" viewBox="-4 -2 16 16" role="img" data-icon="CaretDownSmall" aria-hidden="true">
